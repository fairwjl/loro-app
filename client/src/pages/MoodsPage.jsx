  ...
  return (
    <section className="card">
      ...
      <p className="card-text">
        Track patterns over time. Mood fluctuation is normal, especially during recovery. 
        Use this data to notice patterns, not to judge yourself.
      </p>
      ...
      >
        <strong>About tracking:</strong> Some people find tracking helpful for noticing patterns. 
        Others find it increases anxiety or becomes a way to avoid feelings. If tracking starts to feel 
        compulsive or makes you feel worse, it's okay to take a break from it.
      </div>

      <div style={{display:'flex', alignItems:'center', gap:'0.75rem', marginBottom:'0.5rem'}}>
        <span className="muted">Last 7 days (mood)</span>
      ...
      <div className="form-grid">
        ...
        <label>
          Nervous system state (1 = shutdown/numb, 3 = balanced, 5 = anxious/overwhelmed)
          ...
          <div style={{fontSize: 11, color: 'var(--text-muted)', marginTop: 4}}>
            Both low (shutdown) and high (anxious) can mean you're outside your window of tolerance
          </div>
        </label>
        ...
        <label>
          ...
          <div style={{fontSize: 11, color: 'var(--text-muted)', marginTop: 4}}>
            Sleep disruption is common during healing
          </div>
        </label>
        ...
        <label style={{gridColumn:'1 / -1'}}>
          ...
          <textarea rows={3} value={notes} onChange={e=>setNotes(e.target.value)} 
                    placeholder="Context, triggers, what helped, small wins..." />
        </label>
      </div>
          ...
          <div className="list">
            {recent.map(r => (
              <div key={r.d} className="list-row">
                ...
                <div>State: <strong>{r.arousal}</strong></div>
